...
//Serial.println(millis());
  ...
  if(Ping.ping(remote_ip)) {      //задание триггера, который отслеживает пинг до цели, 
    ...
    myTimer2 = millis();
      if (sterttrigger == 1){
          timerconnectlost = millis();
          while (timerconnectlost<10000){
          
              Serial.println("пинга нет, программа была запущена давно, жду востановления соединения");
              sterttrigger = 2; //
              myTimer1 = millis();
          } 
      }
  ...
  if (triger == 2 && wifitrigger == 0 && myTimer2 - myTimer1 > 10000 && sterttrigger == 2){ //проверика по главному выелючателю на интерфейсе, включен ли он, проверка по триггеру пинга, проверка сколько прошло времени
  ...
  if (triger == 2 && wifitrigger == 0 && myTimer2 - myTimer1 > 15000 && sterttrigger == 3){ //проверика по главному выелючателю на интерфейсе, включен ли он, проверка по триггеру пинга, проверка сколько прошло времени
      //digitalWrite (PIN_BUTTON_1, HIGH);
  ...
  if (triger == 2 && wifitrigger == 0 && myTimer2 - myTimer1 > 20000 && sterttrigger == 4){ //проверика по главному выелючателю на интерфейсе, включен ли он, проверка по триггеру пинга, проверка сколько прошло времени
      //digitalWrite (PIN_BUTTON_1, HIGH);
  ...
  if (triger == 2 && wifitrigger == 0 && myTimer2 - myTimer1 > 25000 && sterttrigger == 5){ //проверика по главному выелючателю на интерфейсе, включен ли он, проверка по триггеру пинга, проверка сколько прошло времени
      //digitalWrite (PIN_BUTTON_1, HIGH);
  ...
  if (triger == 2 && wifitrigger == 0 && myTimer2 - myTimer1 > 30000 && sterttrigger == 6){ //проверика по главному выелючателю на интерфейсе, включен ли он, проверка по триггеру пинга, проверка сколько прошло времени
      //digitalWrite (PIN_BUTTON_1, HIGH);
   ...
   if (triger == 2 && wifitrigger == 0 && myTimer2 - myTimer1 > 35000 && sterttrigger == 7){ //проверика по главному выелючателю на интерфейсе, включен ли он, проверка по триггеру пинга, проверка сколько прошло времени
      //digitalWrite (PIN_BUTTON_1, HIGH);
   ...
   if (triger == 2 && wifitrigger == 0 && myTimer2 - myTimer1 > 40000 && sterttrigger == 7){ //проверика по главному выелючателю на интерфейсе, включен ли он, проверка по триггеру пинга, проверка сколько прошло времени
      //digitalWrite (PIN_BUTTON_1, HIGH);
